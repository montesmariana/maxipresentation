...
.bg-dark-blue.b--dark-blue.ba.bw2.br3.shadow-5.mh5.center.white[
How far off are these assumptions?
]
...
### Modified noun vs predicated entity `r emo::ji('thinking_face')`

<!-- TODO add examples of occurrences -->

.center[![:img 50%, Plot of heilzaam](img/heilzaam.png)]

---

## Frequency + Distinctiveness `r emo::ji('scream')`

<!-- TODO highlight some groups? Maybe check the kinds of nouns... -->
.pull-left[
![:img 90%, Plot of hoekig](img/hoekig.png)
]

--

.pull-right[
![:img 90%, Plot of hachelijk](img/hachelijk.png)
]

---

## Combination of context words `r emo::ji('star_struck')`

<!-- TODO circle and show positie/situatie -->

.center[![:img 50%, Plot of hachelijk](img/hachelijk.png)]

---

## Internal sense structure `r emo::ji('monocle')`

<!-- TODO add circles with the highest context words -->

.center[![:img 50%, Plot of geldig](img/geldig.png)]
